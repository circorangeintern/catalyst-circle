            ...
            <div className="border-b border-gray-200 flex items-center justify-between py-5 px-5 md:px-10 ">
              ...
              <div className="hidden md:block">
                <ul className="flex gap-6 text-sm text-slate-700">
                  ...
                  <li>
                    <a href="/#faq" className="hover:text-[#0B7A75] transition">
                      FAQ
                    </a>
                  </li>
                </ul>
              ...
              {/* mobile menu panel */}
              {open && (
                <div className="absolute left-0 right-0 top-20 z-40 md:hidden bg-white shadow-lg border-t border-slate-100">
